<template>
  <div id="container" ref="pageContainerRef">
      ...
      <div class="save-button-container" ref="saveButtonContainerRef">
        <div class="save-button" @click="saveArticle">
          <svg ref="refreshIconRef" t="1686294507516" class="icon refresh-icon" viewBox="0 0 1024 1024" version="1.1"
               xmlns="http://www.w3.org/2000/svg" p-id="3374" width="64" height="64">
            <path
    ...
    <div id="setting-container">
      ...
      <div id="setting-item-container">
        <el-row class="setting-item">
          ...
          <el-col :span="8">
            <el-upload :headers="{ 'authorization': token }" accept=".jpg,.jpeg,.png,.webp" class="avatar-uploader"
                       :action="uploadImagePath" :show-file-list="false" :on-success="handleCoverSuccess"
    ...
    <div id="operation-container">
      <el-button size="large" type="primary" @click="addArticle('2', false)"
                 v-if="articleState !== '2'">发布文章
      </el-button>
      <el-button size="large" type="info" @click="addArticle('1', false)" v-if="articleState !== '2'">保存文章
      </el-button>
      <el-button size="large" type="primary" @click="updateArticle(false)" v-if="articleState === '2'">修改文章
      </el-button>
    </div>
  </div>
</template>
